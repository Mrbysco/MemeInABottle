...
import com.Mrbysco.miab.models.ModelBill;
...
public class RenderBill extends RenderLiving<EntityBill> {
	  ...
	  private static final ResourceLocation texture = new ResourceLocation(Reference.MOD_PREFIX + "textures/entity/billcipher.png");
