...
public class RenderPpap extends RenderMemeBase 
{
	  ...
	  private static final ResourceLocation texture = new ResourceLocation(Reference.MOD_PREFIX + "textures/entity/kosakadaimaou.png");

	  public RenderPpap(RenderManager p_i46143_1_) {
	    super(p_i46143_1_);
	  }
