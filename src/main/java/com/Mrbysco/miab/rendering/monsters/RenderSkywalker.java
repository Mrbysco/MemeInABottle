...
public class RenderSkywalker extends RenderMemeBase 
{
	  public static final Factory FACTORY = new Factory();
	  
	  private static final ResourceLocation texture = new ResourceLocation(Reference.MOD_PREFIX + "textures/entity/skywalker.png");

	  public RenderSkywalker(RenderManager p_i46143_1_) {
	    super(p_i46143_1_);
	  }
	  ...
	  public static class Factory implements IRenderFactory<EntityMemeBase> {
	    ...
	    public Render<? super EntityMemeBase> createRenderFor(RenderManager manager) {
	      return new RenderSkywalker(manager);
	    }
	  }
}
