...
public class EntityHeMan extends EntityMemeBase 
{

	ItemStack itemstack = this.getHeldItemMainhand();
	
	public static String NAME = "He-Man";
	
	private boolean isMounted = false;
	
	public EntityHeMan(World world) {
	    super(world);
	    }
	...
	{
		return new ResourceLocation("memeinabottle:entity/heman");
	}
	
	@Override
	public IEntityLivingData onInitialSpawn(DifficultyInstance difficulty, IEntityLivingData livingdata) {
		this.playSound(MemeSounds.heman_spawn, 1F, 1F);
		if (rand.nextInt(2) < 1) 
		{
