...
{
    public EntityKnucklesBase owner;
    ...
    public EntityKnucklesSpit(World worldIn, EntityKnucklesBase entity)
    {
        super(worldIn);
        this.owner = entity;
        this.setPosition(entity.posX - (double)(entity.width + 1.0F) * 0.5D * (double)MathHelper.sin(entity.renderYawOffset * 0.017453292F), entity.posY + (double)entity.getEyeHeight() - 0.10000000149011612D, entity.posZ + (double)(entity.width + 1.0F) * 0.5D * (double)MathHelper.cos(entity.renderYawOffset * 0.017453292F));
    ...
    private void restoreOwnerFromSave()
    {
        if (this.ownerNbt != null && this.ownerNbt.hasUniqueId("OwnerUUID"))
        {
            ...
            for (EntityKnucklesBase entityllama : this.world.getEntitiesWithinAABB(EntityKnucklesBase.class, this.getEntityBoundingBox().grow(15.0D)))
            {
