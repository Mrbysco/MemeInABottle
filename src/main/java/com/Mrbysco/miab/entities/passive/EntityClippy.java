...
public class EntityClippy extends EntityCreature implements IMob
{
	public float jumpAmount;
    public float jumpFactor;
    public float prevJumpFactor;
    private boolean wasOnGround;
	public static String NAME = "Clippy";
	...
	protected SoundEvent getAmbientSound() {
		...
		if(!this.isDead)
		{
			...
			if(biome == Biomes.FOREST || biome == Biomes.BIRCH_FOREST || biome == Biomes.MUTATED_BIRCH_FOREST || biome == Biomes.MUTATED_FOREST || biome == Biomes.ROOFED_FOREST)
			{
