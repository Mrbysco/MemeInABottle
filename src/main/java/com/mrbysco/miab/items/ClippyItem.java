...
public class ClippyItem extends MemeBaseItem {
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, PlayerEntity playerIn, Hand handIn) {
		...
		if (raytraceresult == null) {
			...
			ClippyEntity clippy = MemeEntities.CLIPPY.get().create(worldIn);
			if(clippy != null) {
	...
	public void addInformation(ItemStack stack, @Nullable World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
		...
		tooltip.add(new TranslationTextComponent(Reference.MOD_PREFIX + "clippy.info").mergeStyle(TextFormatting.YELLOW));
	}
}
