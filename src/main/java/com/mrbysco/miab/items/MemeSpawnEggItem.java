...
public class MemeSpawnEggItem extends SpawnEggItem {
    private static final Map<Supplier<EntityType<?>>, MemeSpawnEggItem> EGGS = Maps.newIdentityHashMap();
    private final Supplier<EntityType<?>> typeIn;
    private final int primaryColor;
    private final int secondaryColor;

    public MemeSpawnEggItem(Supplier<EntityType<?>> type, int primary, int secondary, Properties properties) {
        super(null, primary, secondary, properties.group(MemeTab.MEME_TAB));
        this.typeIn = type;
    ...
    public static Iterable<MemeSpawnEggItem> getMemeEggs() {
