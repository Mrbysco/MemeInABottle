...
public class DankeyRenderer extends AbstractHumanoidRenderer<DankeyEntity, HumanBaseModel<DankeyEntity>> {
	...
	public DankeyRenderer(EntityRendererProvider.Context context, ModelLayerLocation layerLocation,
	...
	public ResourceLocation getTextureLocation(DankeyEntity entity) {
		return TEXTURE;
	}
}
