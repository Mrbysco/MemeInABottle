...
public class FAModel<T extends FAEntity> extends HumanBaseModel<T> {
	...
	public static MeshDefinition createMesh(CubeDeformation cubeDeformation) {
		...
		partdefinition.addOrReplaceChild("head", CubeListBuilder.create()
				.texOffs(1, 43).addBox(-5.0F, -7.0F, -4.0F, 10.0F, 7.0F, 8.0F, cubeDeformation)
				.texOffs(0, 32).addBox(-5.0F, -10.0F, -4.0F, 9.0F, 3.0F, 7.0F, cubeDeformation), PartPose.offset(0.0F, 0.0F, 0.0F));
