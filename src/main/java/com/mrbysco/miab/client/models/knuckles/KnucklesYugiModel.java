...
public class KnucklesYugiModel<T extends KnucklesEntity> extends SegmentedModel<T> {
	...
	public KnucklesYugiModel() {
		...
		triangle.setRotationPoint(0.0F, 4.0F, -0.6F);
		chest.addChild(triangle);
		triangle.setTextureOffset(0, 19).addBox(-1.0F, -1.0F, -0.5F, 2.0F, 2.0F, 1.0F, 0.0F, false);
		...
		hair_1.setRotationPoint(-0.5F, -4.5F, -0.5F);
