...
public class KnucklesYugiModel<T extends KnucklesEntity> extends EntityModel<T> {
	...
	public KnucklesYugiModel(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition hair_1 = head.addOrReplaceChild("hair_1", CubeListBuilder.create().texOffs(0, 13).addBox(-2.0F, -2.0F, -1.0F, 4.0F, 4.0F, 2.0F), PartPose.offsetAndRotation(-0.5F, -4.5F, -0.5F, 0.0F, 0.0F, 0.7854F));
		...
		PartDefinition triangle = torso.addOrReplaceChild("triangle", CubeListBuilder.create().texOffs(0, 19).addBox(-1.0F, -1.0F, -0.5F, 2.0F, 2.0F, 1.0F), PartPose.offset(0.0F, 4.0F, -0.6F));
