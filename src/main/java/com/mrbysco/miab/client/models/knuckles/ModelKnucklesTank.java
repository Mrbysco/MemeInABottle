...
public class ModelKnucklesTank<T extends EntityKnuckles> extends EntityModel<T> {
	public RendererModel tank;
    public RendererModel tank_2;
    public RendererModel cannon;
    public RendererModel tank_side;
    public RendererModel tank_side_2;
    public RendererModel wheels_1;
    public RendererModel wheels_2;
    ...
    public RendererModel left_hand;
    ...
    public ModelKnucklesTank() {
        ...
        this.cannon = new RendererModel(this, 56, 107);
        ...
        this.wheels_1 = new RendererModel(this, 0, 73);
