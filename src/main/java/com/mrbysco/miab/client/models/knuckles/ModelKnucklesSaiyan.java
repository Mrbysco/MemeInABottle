...
public class ModelKnucklesSaiyan<T extends EntityKnuckles> extends EntityModel<T> {
    ...
    public RendererModel hair_6;
    public RendererModel hair_7;
    public RendererModel hair_8;
    ...
    public ModelKnucklesSaiyan() {
        ...
        this.hair_6 = new RendererModel(this, 0, 13);
        ...
        this.hair_7 = new RendererModel(this, 0, 13);
        ...
        this.hair_8 = new RendererModel(this, 0, 13);
