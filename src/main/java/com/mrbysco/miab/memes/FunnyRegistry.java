...
public class FunnyRegistry {
	...
	public void initializeMemes() {
		...
		//End of mature ish sounds

		//Item memes
		registerMeme(new BasicItemMeme(Reference.MOD_PREFIX + "leather_belt", 10, MemeSounds.leather_belt.get(), new ItemStack(com.mrbysco.miab.registry.MemeRegistry.LEATHER_BELT.get())));
		registerMeme(new BasicItemMeme(Reference.MOD_PREFIX + "trumpet", 10, MemeSounds.doot.get(), new ItemStack(com.mrbysco.miab.registry.MemeRegistry.TRUMPET.get())));
		registerMeme(new BasicItemMeme(Reference.MOD_PREFIX + "splash_meme", 10, MemeSounds.inception.get(), new ItemStack(com.mrbysco.miab.registry.MemeRegistry.SPLASH_MEME_IN_A_BOTTLE.get())));
		registerMeme(new BasicItemMeme(Reference.MOD_PREFIX + "pills_here", 10, MemeSounds.pills.get(), new ItemStack(com.mrbysco.miab.registry.MemeRegistry.PILLS.get())));
		...
		registerMeme(new AnimalMeme(Reference.MOD_PREFIX + "grumpy_cat", 5, MemeEntities.GRUMPY_CAT.get(), SoundEvents.CAT_PURR));
		registerMeme(new AnimalMeme(Reference.MOD_PREFIX + "doge", 5, MemeEntities.DOGE.get(), SoundEvents.WOLF_GROWL));
	...
	public void triggerRandomMeme(Level level, BlockPos pos, Player playerIn) {
	...
	public void checkDisabled() {
		List<String> disabledMemes = new ArrayList<>(MemeConfig.SERVER.disabledMemes.get());
		if (!MemeConfig.SERVER.matureSounds.get()) {
			disabledMemes.add(Reference.MOD_PREFIX + "sound_cantbelieve");
			disabledMemes.add(Reference.MOD_PREFIX + "sound_morningscrub");
			disabledMemes.add(Reference.MOD_PREFIX + "sound_gotcha");
			disabledMemes.add(Reference.MOD_PREFIX + "sound_hagay");
			disabledMemes.add(Reference.MOD_PREFIX + "sound_rightinthe");
			disabledMemes.add(Reference.MOD_PREFIX + "sound_smokeweed");
			disabledMemes.add(Reference.MOD_PREFIX + "sound_snooppengas");
		}
		for (Iterator<iFunny> iterator = funnyList.iterator(); iterator.hasNext(); ) {
			iFunny meme = iterator.next();
