...
public class EntityRoadmanShaq extends AbstractMeme{

	public EntityRoadmanShaq(EntityType<? extends EntityRoadmanShaq> entityType, World worldIn) {
	...
	private void registerTargetGoals() {
		this.targetSelector.addGoal(2, (new HurtByTargetGoal(this)).setCallsForHelp(EntityRoadmanShaq.class));
	}
