...
public class EntityPPAP extends AbstractMeme{
	...
	public EntityPPAP(EntityType<? extends EntityPPAP> entityType, World worldIn) {
	...
	private void registerTargetGoals() {
		this.targetSelector.addGoal(2, (new HurtByTargetGoal(this)).setCallsForHelp(EntityPPAP.class));
	}
