...
public class EntityPhilSwift extends AbstractMeme{

	public EntityPhilSwift(EntityType<? extends EntityPhilSwift> entityType, World worldIn) {
	...
	private void registerTargetGoals() {
		this.targetSelector.addGoal(2, (new HurtByTargetGoal(this)).setCallsForHelp(EntityPhilSwift.class));
	}
