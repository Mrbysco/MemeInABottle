...
public class EntityAttachedGirlfriend extends AbstractMeme{
	...
	public EntityAttachedGirlfriend(EntityType<? extends EntityAttachedGirlfriend> entityType, World worldIn) {
	...
	private void registerTargetGoals() {
		this.targetSelector.addGoal(2, (new HurtByTargetGoal(this)).setCallsForHelp(EntityAttachedGirlfriend.class));
}
