...
public class PhilSwiftEntity extends AbstractMeme{
	...
	public PhilSwiftEntity(EntityType<? extends PhilSwiftEntity> entityType, World worldIn) {
	...
	private void registerTargetGoals() {
		this.targetSelector.addGoal(2, (new HurtByTargetGoal(this)).setCallsForHelp(PhilSwiftEntity.class));
	}
