...
public class EntityFA extends AbstractMeme{

	public EntityFA(EntityType<? extends EntityFA> entityType, World worldIn) {
	...
	private void registerTargetGoals() {
		this.targetSelector.addGoal(2, (new HurtByTargetGoal(this)).setCallsForHelp(EntityFA.class));
	}
