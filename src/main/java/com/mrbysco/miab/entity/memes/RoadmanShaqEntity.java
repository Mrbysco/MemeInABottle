...
public class RoadmanShaqEntity extends AbstractMeme{
	...
	public RoadmanShaqEntity(EntityType<? extends RoadmanShaqEntity> entityType, World worldIn) {
	...
	private void registerTargetGoals() {
		this.targetSelector.addGoal(2, (new HurtByTargetGoal(this)).setCallsForHelp(RoadmanShaqEntity.class));
	}
