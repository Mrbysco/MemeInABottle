...
public class EntityDatBoi extends AbstractMeme{
	...
	public EntityDatBoi(EntityType<? extends EntityDatBoi> entityType, World worldIn) {
	...
	private void registerTargetGoals() {
		this.targetSelector.addGoal(2, (new HurtByTargetGoal(this)).setCallsForHelp(EntityDatBoi.class));
	}
