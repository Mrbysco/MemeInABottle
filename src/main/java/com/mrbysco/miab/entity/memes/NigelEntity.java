...
public class NigelEntity extends AbstractMeme{
	...
	public NigelEntity(EntityType<? extends NigelEntity> entityType, World worldIn) {
	...
	private void registerTargetGoals() {
		this.targetSelector.addGoal(2, (new HurtByTargetGoal(this)).setCallsForHelp(NigelEntity.class));
	}
