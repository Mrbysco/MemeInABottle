...
public class SansEntity extends AbstractMeme {
	public SansEntity(EntityType<? extends SansEntity> entityType, Level world) {
	...
	private void registerTargetGoals() {
		this.targetSelector.addGoal(2, (new HurtByTargetGoal(this)).setAlertOthers(SansEntity.class));
	}
