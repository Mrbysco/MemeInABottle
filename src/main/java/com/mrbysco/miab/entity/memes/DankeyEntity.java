...
public class DankeyEntity extends AbstractMeme{

	public DankeyEntity(EntityType<? extends DankeyEntity> entityType, World worldIn) {
	...
	private void registerTargetGoals() {
		this.targetSelector.addGoal(2, (new HurtByTargetGoal(this)).setCallsForHelp(DankeyEntity.class));
	}
