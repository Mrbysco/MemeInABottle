...
public class RoflCopterEntity extends CreatureEntity {
	private static final DataParameter<Byte> LANDED = EntityDataManager.<Byte>createKey(RoflCopterEntity.class, DataSerializers.BYTE);

	/** Coordinates of where the rofl spawned. */
	private BlockPos spawnPosition;

	public RoflCopterEntity(EntityType<? extends RoflCopterEntity> entityType, World worldIn) {
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(1, (new HurtByTargetGoal(this)).setCallsForHelp(RoflCopterEntity.class));
	}
	...
	protected void updateAITasks() {
		...
		if (this.getIsCopterLanded()) {
			...
			if (this.spawnPosition == null || this.rand.nextInt(30) == 0 ||
					this.spawnPosition.distanceSq((double)((int)this.getPosX()), (double)((int)this.getPosY()), (double)((int)this.getPosZ()), true) < 4.0D) {
