...
public class EntityPepe extends AbstractMeme{

	public EntityPepe(EntityType<? extends EntityPepe> entityType, World worldIn) {
	...
	private void registerTargetGoals() {
		this.targetSelector.addGoal(2, (new HurtByTargetGoal(this)).setCallsForHelp(EntityPepe.class));
	}
