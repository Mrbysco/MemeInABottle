...
public class EntityDankey extends AbstractMeme{

	public EntityDankey(EntityType<? extends EntityDankey> entityType, World worldIn) {
	...
	private void registerTargetGoals() {
		this.targetSelector.addGoal(2, (new HurtByTargetGoal(this)).setCallsForHelp(EntityDankey.class));
	}
