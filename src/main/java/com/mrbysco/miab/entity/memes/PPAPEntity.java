...
public class PPAPEntity extends AbstractMeme{

	public PPAPEntity(EntityType<? extends PPAPEntity> entityType, World worldIn) {
	...
	private void registerTargetGoals() {
		this.targetSelector.addGoal(2, (new HurtByTargetGoal(this)).setCallsForHelp(PPAPEntity.class));
	}
