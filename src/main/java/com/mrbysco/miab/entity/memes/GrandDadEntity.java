...
public class GrandDadEntity extends AbstractMeme {
	...
	public GrandDadEntity(EntityType<? extends GrandDadEntity> entityType, Level level) {
	...
	private void registerTargetGoals() {
		this.targetSelector.addGoal(2, (new HurtByTargetGoal(this)).setAlertOthers(GrandDadEntity.class));
	}
