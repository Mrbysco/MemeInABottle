...
public class EntityAICallForKnuckles extends EntityAITarget
{
	...
	public EntityAICallForKnuckles(EntityCreature creatureIn, boolean entityCallsForHelpIn, Class<?>... excludedReinforcementTypes)
	{
	...
	protected void alertOthers()
	{
		...
		{
			//if (this.taskOwner != entitycreature && entitycreature.getAttackTarget() == null && (!(this.taskOwner instanceof EntityTameable)
			...
			if (this.taskOwner != entitycreature && entitycreature instanceof EntityKnuckles)
			{
				boolean flag = false;
