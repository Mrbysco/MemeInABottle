...
public class MemeRegister {
	...
	public static final RegistryObject<Item> pen_pineapple = ITEMS.register("pineapple_pen", () -> new ItemMusical(itemBuilder(), () -> MemeSounds.ppap_ahpineapplepen.get(), () -> MemeSounds.ppap_pineapplepen.get(), 5, Reference.MOD_PREFIX + "instrument.info"));
	public static final RegistryObject<Item> apple_pen = ITEMS.register("apple_pen", () -> new ItemMusical(itemBuilder(), () -> MemeSounds.ppap_ahapplepen.get(), () -> MemeSounds.ppap_applepen.get(), 5, Reference.MOD_PREFIX + "instrument.info"));
